...
def init_checklist():
    """Inicializar el checklist con los items por defecto si está vacío."""
    try:
        ...
        items = [
            ...
            ("🔌 Tecnología","Fotos de reservas en el teléfono"),
        ...
        st.warning(f"No se pudo inicializar el checklist: {e}")
...
CIUDADES_CLIMA = {
    ...
    "Venecia":     {"lat":45.44,"lon":12.33,"fecha":"2026-06-10"},
...
WMO_CODES = {
    ...
    65:"🌧️ Lluvia intensa",71:"❄️ Nieve leve",80:"🌦️ Chubascos",
    81:"🌧️ Chubascos mod.",82:"⛈️ Chubascos fuertes",95:"⛈️ Tormenta",
    96:"⛈️ Tormenta granizo",99:"⛈️ Tormenta granizo fuerte",
}
...
RUTA_MAPA = [
    ...
    {"city":"Nápoles","lat":40.8518,"lon":14.2681,"dias":"D14","emoji":"🍕","color":"#C4693A"},
    {"city":"Pompeya","lat":40.7497,"lon":14.4990,"dias":"D14 excursión","emoji":"🌋","color":"#8B3E1E"},
    {"city":"Positano","lat":40.6278,"lon":14.4841,"dias":"D15","emoji":"🌅","color":"#6B7A3E"},
    {"city":"Amalfi","lat":40.6340,"lon":14.6027,"dias":"D15","emoji":"⛪","color":"#6B7A3E"},
    {"city":"Ravello","lat":40.6490,"lon":14.6130,"dias":"D16","emoji":"🌿","color":"#C9A84C"},
    {"city":"Venecia","lat":45.4408,"lon":12.3155,"dias":"D17","emoji":"🚤","color":"#C4693A"},
...
def render_milan():
    ...
    _card("Día 1","Lunes 25 mayo — Llegada y primer paseo","Milán",
        _ev("10:15",True,"Llegada MXP — Inmigración y aduana","Pasaporte argentino. Calcular 30–45 min en inmigración en temporada alta.") +
        _ev("11:30",False,"Malpensa Express → Milano Centrale","Sale cada 30 min. 52 minutos. Comprar en máquinas Trenord o app. Validar antes de subir.",
        ...
        _ev("13:30",False,"Check-in + almuerzo tranquilo","Risotto alla milanese o cotoletta en trattoria local. Evitar restaurantes junto a estaciones.",acts='<span class="tag tf">🍝 Risotto</span>') +
        _ev("15:00",False,"Siesta obligatoria","Vienen de 11h de vuelo nocturno. 2–3 horas de siesta es clave para los días siguientes.") +
        _ev("18:00",False,"Paseo Navigli + Aperitivo","Los canales al atardecer. Aperol Spritz al borde del canal. Mejor zona: Alzaia Naviglio Grande.",acts='<span class="tag tw">🚶 Paseo</span><a href="https://maps.google.com/?q=Navigli+Milan" target="_blank" class="lb bm">📍 Maps</a>'))
    _card("Día 2","Martes 26 mayo — Última Cena, Duomo, Shopping y Pádel","Milán",
        _ev("08:00",False,"Desayuno italiano","Bar local: cappuccino + cornetto. No pedir cappuccino después del mediodía.",acts='<span class="tag tf">☕ €3</span>') +
        _ev("08:15",True,"LA ÚLTIMA CENA — Santa Maria delle Grazie","El fresco más famoso del mundo. RESERVA OBLIGATORIA. Solo 25 personas cada 15 minutos. Duración: 15 min exactos.",
        ...
        _ev("10:00",True,"Duomo di Milano — terrazas","Terrazas en ascensor para ver los 135 chapiteles de cerca. Vista 360° de Milán.",
        ...
        _ev("11:30",False,"Galleria Vittorio Emanuele II + Scala","Pisar el toro y girar el talón — trae suerte. Teatro alla Scala (exterior y museo).",acts='<span class="tag tw">🚶 Gratis</span><a href="https://maps.google.com/?q=Galleria+Vittorio+Emanuele+II" target="_blank" class="lb bm">📍 Maps</a>') +
        _ev("13:00",False,"Almuerzo en Brera","Buscar menú del giorno visible en la puerta: primer plato + segundo + agua = €12–15.",acts='<span class="tag tf">🍽️ €15</span><a href="https://maps.google.com/?q=Brera+Milan" target="_blank" class="lb bm">📍 Brera</a>') +
        _ev("15:00",True,"Shopping — Corso Buenos Aires","La calle comercial más larga de Italia. Zara, H&M, Bershka, Mango, marcas italianas accesibles. 2km de tiendas.",acts='<span class="tag ts">🛍️ Ropa</span><a href="https://maps.google.com/?q=Corso+Buenos+Aires+Milan" target="_blank" class="lb bm">📍 Maps</a>') +
        _ev("17:30",True,"Padel Nuestro Milano (opcional)","La mayor tienda de pádel del norte de Italia. Bullpadel, Siux, Adidas, Nox. Pista interior para probar palas.",
        ...
        _ev("20:00",False,"Cena en Navigli","Evitar restaurantes con foto en el menú en la puerta.",acts='<span class="tag tf">🍷 Cena</span>'))
    _card("Día 3","Miércoles 27 mayo — Brera e Isola","Milán",
        _ev("09:00",True,"Pinacoteca di Brera","Mantegna, Raphael, Caravaggio. Una de las mejores colecciones renacentistas de Italia. Calcular 2h.",acts='<span class="tag tm">🎨 €15</span><a href="https://pinacotecabrera.org" target="_blank" class="lb bt">Reservar</a><a href="https://maps.google.com/?q=Pinacoteca+di+Brera+Milan" target="_blank" class="lb bm">📍 Maps</a>') +
        _ev("11:30",False,"Barrio Isola + Bosco Verticale","El famoso bosque vertical de Stefano Boeri. Cafés y mercaditos locales muy cool.",acts='<span class="tag tw">🌿 Gratis</span><a href="https://maps.google.com/?q=Bosco+Verticale+Milan" target="_blank" class="lb bm">📍 Maps</a>') +
        _ev("19:00",False,"Preparar maletas — mañana viajan a Cinque Terre","Tren 08:10 desde Milano Centrale. Poner alarma.",acts='<span class="tag tsl">🧳 Preparación</span>'))

def render_cinque():
    _tcard("🚄","Milano → La Spezia Centrale","Intercity · ~3h · Salida 08:10 desde Milano Centrale","€25–35","https://www.trenitalia.com")
    _hotel("Hotel Firenze ★★★ (La Spezia)","5 min a pie de la estación · Habitación doble · 2 noches<br>Alternativa: alojarse directamente en Monterosso al Mare","~€70–80 / noche · 2 noches",
           "https://www.booking.com/searchresults.es.html?ss=La+Spezia&checkin=2026-05-28&checkout=2026-05-30&group_adults=2",
           "https://www.airbnb.com/s/La-Spezia--Italy/homes?checkin=2026-05-28&checkout=2026-05-30&adults=2","https://maps.google.com/?q=La+Spezia+train+station")
    _card("Día 4","Jueves 28 mayo — Riomaggiore, Manarola, Corniglia","Cinque Terre",
        _ev("11:30",False,"Llegada La Spezia — Check-in + Cinque Terre Card","Comprar la Card 2 días en InfoParco o taquilla de la estación (~€29.50/persona). Incluye todos los trenes locales.",acts='<span class="tag tkt">🎫 €29.50 · 2 días</span><a href="https://www.cinqueterre.eu.com/en/cinque-terre-card" target="_blank" class="lb bt">Info Card</a>') +
        _ev("12:30",True,"Riomaggiore — el más fotogénico","Bajar al puerto pequeño. Almuerzo: focaccia con pesto ligurio + vino sciacchetrà.",acts='<span class="tag tf">🍃 Pesto original</span><a href="https://maps.google.com/?q=Riomaggiore+Cinque+Terre" target="_blank" class="lb bm">📍 Maps</a>') +
        _ev("15:30",True,"Manarola — el mirador icónico","La foto de las casas pastel sobre las rocas. Bajar al muelle de natación. 1.5h.",acts='<span class="tag tw">📸 Foto icónica</span><a href="https://maps.google.com/?q=Manarola+Cinque+Terre" target="_blank" class="lb bm">📍 Maps</a>') +
        _ev("17:30",False,"Corniglia — vista 360°","El único pueblo en lo alto. 377 escalones o minibus desde la estación.",acts='<a href="https://maps.google.com/?q=Corniglia+Cinque+Terre" target="_blank" class="lb bm">📍 Maps</a>'))
    _card("Día 5","Viernes 29 mayo — Vernazza, senderismo y Monterosso","Cinque Terre",
        _ev("08:00",True,"Vernazza — el más medieval","Castillo Doria (€1.50) para la mejor vista. Puerto pintoresco. 2h.",acts='<a href="https://maps.google.com/?q=Vernazza+Cinque+Terre" target="_blank" class="lb bm">📍 Maps</a>') +
        _ev("11:00",True,"Senderismo Vernazza → Monterosso (3.5 km · 2h)","El sendero más espectacular. Verificar estado en parconazionale5terre.it antes de ir.",
        ...
        _ev("14:00",False,"Monterosso — playa y anchoas","El único pueblo con playa de arena real. Probar acciughe (anchoas de Monterosso). Reposeras ~€5. Agua ~22°C.",acts='<span class="tag tw">🏖️ Playa</span><a href="https://maps.google.com/?q=Monterosso+al+Mare" target="_blank" class="lb bm">📍 Maps</a>'))
...
def render_florencia():
    ...
    _card("Día 7","Domingo 31 mayo — Uffizi + David + San Miniato","Florencia",
        ...
        _ev("17:30",False,"San Miniato al Monte","La iglesia más bella de Florencia — gratis. Los monjes rezan el Oficio en gregoriano a las 17:30.",acts='<span class="tag tw">⛪ Gratis</span><a href="https://maps.google.com/?q=San+Miniato+al+Monte+Florence" target="_blank" class="lb bm">📍 Maps</a>'))
    _card("Día 8","Lunes 1 junio — Palazzo Pitti + Boboli + Cappelle Medicee","Florencia",
        _ev("09:00",False,"Palazzo Pitti + Jardines de Boboli","El palacio de los Medici. Rafael y Tiziano en la Galleria Palatina. Jardines renacentistas con gruta de Buontalenti (1583).",acts='<span class="tag tm">🏰 €16</span><a href="https://maps.google.com/?q=Palazzo+Pitti+Florence" target="_blank" class="lb bm">📍 Maps</a>') +
        _ev("16:00",True,"Cappelle Medicee — Michelangelo","Las tumbas de los Medici con las esculturas: Aurora, Crepúsculo, Día y Noche. Igual de impactantes que el David.",acts='<span class="tag tm">🗿 €9</span><a href="https://maps.google.com/?q=Cappelle+Medicee+Florence" target="_blank" class="lb bm">📍 Maps</a>'))
    _card("Día 9","Martes 2 junio — Siena y Val d'Orcia","Toscana",
        _ev("07:30",False,"Bus SENA desde Florencia a Siena","Desde Autostazione di Firenze (frente a Santa Maria Novella). 1.5h · €9.",acts='<span class="tag tbu">🚌 €9</span><a href="https://maps.google.com/?q=Autostazione+Firenze" target="_blank" class="lb bm">📍 Bus</a>') +
        _ev("09:00",True,"Piazza del Campo + Torre del Mangia","La plaza más bella de Italia en forma de concha. La Torre tiene 400 escalones y vistas impresionantes.",acts='<span class="tag tm">🏰 Torre €10</span><a href="https://maps.google.com/?q=Piazza+del+Campo+Siena" target="_blank" class="lb bm">📍 Maps</a>') +
        _ev("10:00",False,"Duomo di Siena","El Duomo de Siena compite con Florencia en belleza. El pavimento de mármol con 56 escenas es único en el mundo.",acts='<span class="tag tm">⛪ €8</span><a href="https://maps.google.com/?q=Siena+Cathedral" target="_blank" class="lb bm">📍 Maps</a>') +
        _ev("13:30",False,"Almuerzo en la ciudad vieja","Probar: pici all'aglione (pasta gruesa con ajo), cinghiale (jabalí). Siena tiene cocina muy diferente a Florencia.",acts='<span class="tag tf">🍖 Toscana</span>') +
        _ev("17:00",False,"Bus de regreso a Florencia","Hay buses frecuentes hasta las 21:00. Cena en Florencia. Mañana viajan a Roma."))
...
def render_roma():
    ...
    _hotel("Hotel Arco del Lauro ★★★ (Trastevere)","Zona Trastevere — auténtica y central · B&B familiar · Muy buenas reseñas<br>Alternativa: zona Prati (junto al Vaticano) o Hotel Santa Prassede (~€80)","~€80–95 / noche · 4 noches",
           "https://www.booking.com/searchresults.es.html?ss=Rome&checkin=2026-06-03&checkout=2026-06-07&group_adults=2",
           "https://www.airbnb.com/s/Rome--Italy/homes?checkin=2026-06-03&checkout=2026-06-07&adults=2","https://maps.google.com/?q=Trastevere+Rome")
    ...
    _card("Día 10","Miércoles 3 junio — Vaticano completo","Roma",
        _ev("10:30",True,"Museos Vaticanos + Capilla Sixtina","Los museos más visitados del mundo. 3–4h. RESERVA OBLIGATORIA.",tip="⚠️ En la Capilla Sixtina está prohibido fotografiar y hacer ruido — los guardias son estrictos. Silencio absoluto.",acts='<span class="tag tm">🎨 €17 + €4 reserva</span><a href="https://www.museivaticani.va" target="_blank" class="lb bt">🎟️ Reservar</a><a href="https://maps.google.com/?q=Vatican+Museums+Rome" target="_blank" class="lb bm">📍 Maps</a>') +
        _ev("14:00",False,"Basílica de San Pedro + Cúpula","La basílica más grande del mundo cristiano. Subir a la cúpula (551 escalones o ascensor parcial €8).",acts='<span class="tag tm">⛪ Gratis · Cúpula €8</span><a href="https://maps.google.com/?q=St+Peters+Basilica+Rome" target="_blank" class="lb bm">📍 Maps</a>'))
    _card("Día 11","Jueves 4 junio — Roma Imperial","Roma",
        _ev("08:00",True,"Coliseo + Foro Romano + Palatino","Combo obligatorio. 3–4h. El Palatino tiene las mejores vistas del Coliseo y es el menos visitado — no saltearlo.",acts='<span class="tag tm">🏛️ €16 + reserva</span><a href="https://www.coopculture.it" target="_blank" class="lb bt">🎟️ Reservar</a><a href="https://maps.google.com/?q=Colosseum+Rome" target="_blank" class="lb bm">📍 Maps</a>') +
        _ev("17:30",False,"Trastevere — paseo y cena","El barrio medieval más pintoresco de Roma. La Basílica di Santa Maria in Trastevere (siglo XII, gratis). Cena: Da Enzo al 29.",acts='<span class="tag tw">🚶 Paseo</span><a href="https://maps.google.com/?q=Trastevere+Rome" target="_blank" class="lb bm">📍 Maps</a>'))
    _card("Día 12","Viernes 5 junio — Roma Barroca + Borghese + Pádel","Roma",
        _ev("09:00",False,"Pantheon → Piazza Navona → Fontana di Trevi","El Pantheon (125 d.C.) requiere ticket €5 desde 2023. Trevi: lanzar la moneda de espaldas con la derecha.",acts='<span class="tag tm">🏛️ Pantheon €5</span><a href="https://maps.google.com/?q=Pantheon+Rome" target="_blank" class="lb bm">📍 Pantheon</a><a href="https://maps.google.com/?q=Trevi+Fountain+Rome" target="_blank" class="lb bm">📍 Trevi</a>') +
        _ev("15:00",True,"Galería Borghese — Bernini","El museo más exclusivo de Roma — solo 360 personas cada 2 horas. Apolo y Dafne, El rapto de Proserpina — lo más impactante de toda Roma.",acts='<span class="tag tm">🗿 €15 + €2 reserva</span><a href="https://www.galleriaborghese.it" target="_blank" class="lb bt">🎟️ Reservar</a><a href="https://maps.google.com/?q=Galleria+Borghese+Rome" target="_blank" class="lb bm">📍 Maps</a>') +
        _ev("18:00",True,"🎾 Padel Nuestro Roma","La tienda más completa de pádel en Roma. Bullpadel, Siux, Adidas, Star Vie, Babolat, Head. Pista interior para probar palas.",acts='<span class="tag tpa">🎾 Pádel Roma</span><a href="https://maps.google.com/?q=Padel+Nuestro+Roma+Italy" target="_blank" class="lb bm">📍 Maps</a><a href="https://www.padelnuestro.com" target="_blank" class="lb bt">Web tienda</a>'))
    _card("Día 13","Sábado 6 junio — Castel Sant'Angelo + tarde libre","Roma",
        _ev("09:00",False,"Castel Sant'Angelo","Mausoleo de Adriano convertido en fortaleza papal. Vista del Tiber y San Pedro desde la cima.",acts='<span class="tag tm">🏰 €14</span><a href="https://maps.google.com/?q=Castel+Sant+Angelo+Rome" target="_blank" class="lb bm">📍 Maps</a>') +
        _ev("14:00",False,"Tarde libre + preparación","Compras en Via del Corso o zona Spagna. Mañana temprano: tren a Nápoles.",acts='<span class="tag tw">🛍️ Libre</span>'))

def render_napoles():
    _tcard("🚄","Roma Termini → Napoli Centrale","Frecciarossa · 1h10 · Sale cada 30 min desde las 06:00","€20–35","https://www.trenitalia.com")
    _hotel("Hotel Piazza Bellini ★★★ (centro histórico UNESCO)","En el corazón de Spaccanapoli · 1 noche (7–8 junio)","~€75–90 / noche",
           "https://www.booking.com/searchresults.es.html?ss=Naples&checkin=2026-06-07&checkout=2026-06-08&group_adults=2",
           "https://www.airbnb.com/s/Naples--Italy/homes?checkin=2026-06-07&checkout=2026-06-08&adults=2","https://maps.google.com/?q=Piazza+Bellini+Naples")
    _card("Día 14","Domingo 7 junio — Pompeya + Nápoles + Pizza","Nápoles",
        _ev("09:00",True,"Circumvesuviana → Pompeya Scavi","Andén subterráneo (-1) de Napoli Centrale. Sale cada 30 min hacia Sorrento. Bajarse en 'Pompei Scavi'. Comprar ticket en máquina automática.",acts='<span class="tag tr2">🚂 €3 · 40min</span><a href="https://maps.google.com/?q=Pompei+Scavi+station" target="_blank" class="lb bm">📍 Maps</a>') +
        _ev("10:00",True,"Pompeya — ciudad sepultada por el Vesubio","La ciudad romana sepultada en 79 d.C. 3h mínimo. Casa dei Vettii, Anfiteatro, Thermopolium, moldes humanos en el Granario. Llevar agua y sombrero.",acts='<span class="tag tm">🌋 €16</span><a href="https://maps.google.com/?q=Pompeii+Archaeological+Park" target="_blank" class="lb bm">📍 Maps</a>') +
        _ev("15:00",False,"Spaccanapoli + Museo Arqueológico Nacional","La calle que cruza Nápoles histórica. El Museo tiene los mejores objetos de Pompeya y Herculano del mundo.",acts='<span class="tag tm">🏺 €15</span><a href="https://maps.google.com/?q=National+Archaeological+Museum+Naples" target="_blank" class="lb bm">📍 Maps</a>') +
        _ev("19:30",True,"🍕 La pizza napolitana ORIGINAL","Nápoles inventó la pizza. Las tres legendarias: L'Antica Pizzeria da Michele (solo Margherita y Marinara, fila larga), Sorbillo (favorita de los napolitanos), Di Matteo (en Spaccanapoli).",acts='<span class="tag tf">🍕 €5–8</span><a href="https://maps.google.com/?q=L+Antica+Pizzeria+da+Michele+Naples" target="_blank" class="lb bm">📍 Da Michele</a><a href="https://maps.google.com/?q=Pizzeria+Sorbillo+Naples" target="_blank" class="lb bm">📍 Sorbillo</a>'))

def render_amalfi():
    _al("<strong>💰 Tip de presupuesto:</strong> Alojarse en Praiano mantiene el presupuesto de €85–100/noche con vista al mar. Positano mismo supera los €200 fácilmente. Con ferry desde Praiano se llega a Positano en 10 min.")
    ...
    _hotel("Albergo California (Praiano) ★★★","Vista al mar · Desayuno incluido · 10 min de Positano en ferry · 2 noches (8–10 junio)","~€85–100 / noche",
           "https://www.booking.com/searchresults.es.html?ss=Praiano&checkin=2026-06-08&checkout=2026-06-10&group_adults=2",
           "https://www.airbnb.com/s/Praiano--Italy/homes?checkin=2026-06-08&checkout=2026-06-10&adults=2","https://maps.google.com/?q=Praiano+Amalfi+Coast")
    _card("Día 15","Lunes 8 junio — Positano + Amalfi","Costa Amalfi",
        _ev("10:30",True,"Positano — las casas en cascada","El pueblo más fotogénico de la Costa. Playa Grande con guijarros, reposeras ~€20 el par. Agua del Tirreno ~22°C.",acts='<a href="https://maps.google.com/?q=Positano+Amalfi+Coast" target="_blank" class="lb bm">📍 Maps</a>') +
        _ev("13:00",False,"Almuerzo con vista en Positano","Muy caro en Positano. Buscar La Zagara o Il Ritrovo (más económico, en la colina). Probar: scialatielli ai frutti di mare.",acts='<span class="tag tf">🦐 Mariscos</span>') +
        _ev("15:00",True,"Bus SITA → Amalfi ciudad","El bus azul recorre toda la costa. €2.50 el tramo. 40 min por la carretera más espectacular de Italia.",tip="Comprar ticket en tabacchi ANTES de subir. Sentarse del lado DERECHO mirando al mar.",acts='<span class="tag tbu">🚌 €2.50</span><a href="https://maps.google.com/?q=Amalfi+Cathedral" target="_blank" class="lb bm">📍 Maps</a>') +
        _ev("19:30",False,"Cena con vista al mar","El atardecer sobre el Tirreno desde la Costa Amalfi es uno de los espectáculos más bellos de Italia.",acts='<span class="tag tf">🌅 Scialatielli ai frutti</span>'))
    _card("Día 16","Martes 9 junio — Ravello + Sentiero degli Dei","Costa Amalfi",
        _ev("08:00",True,"Ravello — Villa Cimbrone + Terrazza dell'Infinito","Ravello a 350m sobre el mar. La Terraza del Infinito — Wagner llamó a esta vista 'el balcón más bello del mundo'.",acts='<span class="tag tm">🌿 €7</span><a href="https://maps.google.com/?q=Villa+Cimbrone+Ravello" target="_blank" class="lb bm">📍 Maps</a>') +
        _ev("11:00",True,"Sentiero degli Dei — Camino de los Dioses (7.8km · 3h)","El sendero más famoso de la Costa Amalfi. Sale desde Bomerano y baja hasta Positano. Vista de toda la costa desde 600m de altura.",tip="El trayecto baja (no sube), así que el cansancio es manejable. Es el mejor día del viaje para muchos viajeros.",acts='<span class="tag tw">🥾 Trekking</span><a href="https://maps.google.com/?q=Sentiero+degli+Dei+Amalfi+Coast" target="_blank" class="lb bm">📍 Maps</a>') +
        _ev("15:00",False,"Llegada Positano + playa merecida","Después del sendero: baño en el mar. Mañana: ferry + tren largo a Venecia — preparar maletas.",acts='<span class="tag tw">🏖️ Playa</span>'))
...
def render_venecia():
    ...
    _hotel("Hotel Dalla Mora ★★★ (Santa Croce)","Zona auténtica · 10 min a pie de la estación · Venecia real, NO en Mestre (tierra firme)<br>Alternativa: B&B en Cannaregio","~€90–110 / noche",
    ...
    _card("Día 17","Miércoles 10 junio — Venecia completa","Venecia",
        _ev("13:00",True,"Gran Canal en Vaporetto línea 1 (la lenta)","La línea 1 recorre todo el Gran Canal parando en cada estación. 45 minutos de palacios del siglo XIV. Ticket 24h = €25.",acts='<span class="tag tb">🚤 24h = €25</span>') +
        _ev("15:00",True,"Plaza San Marcos + Basílica + Campanile","Basílica siglo XI, estilo bizantino, cúpulas doradas — gratuita con espera. El Campanile (99m) ofrece la mejor vista de Venecia. €10.",acts='<span class="tag tm">🏛️ Gratis + €10 campanile</span><a href="https://maps.google.com/?q=St+Marks+Basilica+Venice" target="_blank" class="lb bm">📍 Maps</a>') +
        _ev("17:00",True,"Perderse sin mapa — la mejor actividad de Venecia","Apagar Google Maps. Venecia tiene 118 islas conectadas por 400 puentes. Los callejones más angostos llevan a los campos más secretos.",acts='<span class="tag tw">🗺️ Sin mapa</span>') +
        _ev("19:30",False,"Spritz veneziano en bacaro + Rialto","El Spritz se inventó en Venecia. Los 'bacari' son los bares tradicionales con 'cicchetti' (tapas de €1–2). Zona Cannaregio para los más auténticos.",acts='<span class="tag tf">🍹 Bacaro</span><a href="https://maps.google.com/?q=Rialto+Bridge+Venice" target="_blank" class="lb bm">📍 Rialto</a>') +
        _ev("21:00",False,"Góndola nocturna (opcional)","Precio fijo oficial: €80 para 30 min (hasta 6 personas). De noche los canales sin turistas son mágicos.",acts='<span class="tag tb">🎭 €80 / góndola</span>'))
...
def render_zurich():
    ...
    _hotel("Hotel Otter ★★ (Langstrasse) o IBIS City West","Zona cool y multicultural · A pie del casco histórico · 3 noches (11–14 junio)<br>Alternativa con vista: Hotel Limmatblick (~€120, sobre el río Limmat)","~€90–110 / noche · 3 noches",
    ...
    _card("Día 18","Jueves 11 junio — Llegada + Altstadt","Zurich",
        _ev("14:00",False,"Bahnhofstrasse + Lago de Zurich","La calle comercial más cara del mundo. Joyerías, Rolex, bancos. El Lago al final para sentarse.",acts='<span class="tag tw">⌚ Paseo</span><a href="https://maps.google.com/?q=Bahnhofstrasse+Zurich" target="_blank" class="lb bm">📍 Maps</a>') +
        _ev("15:30",True,"Altstadt + Grossmünster","La iglesia donde Zwinglio inició la Reforma Protestante en 1519. Subir las torres (€5). El barrio Niederdorf: callejuelas adoquinadas, gremios medievales, cafés.",acts='<a href="https://maps.google.com/?q=Grossmunster+Zurich" target="_blank" class="lb bm">📍 Maps</a>') +
        _ev("18:00",False,"Fraumünster — vitrales de Chagall (1970)","5 vitrales de Marc Chagall en un edificio del siglo XIII. Tesoro de arte moderno en arquitectura medieval. €5.",acts='<span class="tag tm">🎨 €5</span><a href="https://maps.google.com/?q=Fraumunster+Zurich" target="_blank" class="lb bm">📍 Maps</a>'))
    _card("Día 19","Viernes 12 junio — Lago + ETH + Fondue","Zurich",
        _ev("09:00",True,"Crucero Lago de Zurich","ZSG opera cruceros. Recorrido corto 1h o largo 4h hasta Rapperswil. El lago con los Alpes de fondo es icónico.",acts='<span class="tag tb">⛵ €8–30</span><a href="https://www.zsg.ch" target="_blank" class="lb bt">ZSG</a><a href="https://maps.google.com/?q=Lake+Zurich" target="_blank" class="lb bm">📍 Maps</a>') +
        _ev("16:00",False,"Polybahn → terraza ETH (vista gratis)","El funicular universitario de 1889 sube hasta la ETH (la universidad de Einstein). Vista panorámica de Zurich, el lago y los Alpes.",acts='<a href="https://maps.google.com/?q=ETH+Zurich+terrace" target="_blank" class="lb bm">📍 Maps</a>') +
        _ev("20:00",True,"Fondue suiza — Swiss Chuchi","La fondue de queso es el plato nacional suizo. Swiss Chuchi en el Altstadt. Experiencia completa ~€35–45/persona.",acts='<span class="tag tf">🧀 Fondue</span><a href="https://maps.google.com/?q=Swiss+Chuchi+Zurich" target="_blank" class="lb bm">📍 Maps</a>'))
    _card("Día 20","Sábado 13 junio — Uetliberg + Chocolates + Última noche","Zurich",
        _ev("09:00",False,"Uetliberg — la montaña de Zurich","870m. Tren S10 desde HB, 20 min, €5. Vista de Zurich, el lago y los Alpes. Bajada por sendero a Felsenegg.",acts='<span class="tag tw">⛰️ €5 tren</span><a href="https://maps.google.com/?q=Uetliberg+Zurich" target="_blank" class="lb bm">📍 Maps</a>') +
        _ev("13:00",True,"Chocolates Sprüngli + Mercado Bürkliplatz","Sprüngli (desde 1836) — los mejores truffes du jour de Zurich. El mercado de Bürkliplatz los sábados tiene artesanías locales.",acts='<span class="tag tf">🍫 Chocolates</span><a href="https://maps.google.com/?q=Confiserie+Sprungli+Zurich" target="_blank" class="lb bm">📍 Maps</a>') +
        _ev("19:00",True,"Última cena del viaje 🥂","Elegir el restaurante favorito de los días en Zurich. Brindar por el viaje. Hacer check-in online del vuelo LA8799.",acts='<span class="tag tf">🥂 Despedida</span>') +
        _ev("22:00",False,"A dormir — vuelo 08:55 mañana","Alarma: 06:00. Tren HB → ZRH: cada 10 min, 10 min de duración. Estar en aeropuerto a las 07:00.",tip="⚠️ ALARMA 06:00. Sin excepciones.",acts='<span class="tag tsl">✈️ Alarma 06:00</span>'))

CIUDAD_FN = {
    "🏛️ Milán": render_milan, "🌊 Cinque Terre": render_cinque,
    "🌸 Florencia": render_florencia, "🏟️ Roma": render_roma,
    "🍕 Nápoles": render_napoles, "🌅 Costa Amalfi": render_amalfi,
    "🚤 Venecia": render_venecia, "🇨🇭 Zurich": render_zurich,
}
...
TIPS = [
    ...
    ("💶","Coperto en Italia","Un cargo de €1–3 por persona que aparece en la cuenta de restaurantes. Es legal y obligatorio pagarlo. No es una estafa."),
    ("🔌","Enchufe Suiza","Suiza usa enchufe TIPO J — diferente al italiano. Comprar adaptador antes del viaje o en cualquier tienda en Milán."),
    ("📸","Mejor foto Manarola","Ir al mirador 15 min ANTES del sunset. El color de las casas con la luz dorada es incomparable. Llegar temprano para conseguir lugar."),
]
FRASES_ITALIANO = [
...
# ── CARGA ─────────────────────────────────────────────────────────────────────
try:
    df_res=load_r(); df_gas=load_g(); df_notas=load_n(); df_chk=load_chk(); sheets_ok=True
    init_checklist()
...
chk_done = 0 if df_chk.empty else len(df_chk[df_chk.get("done","0").astype(str)=="1"]) if "done" in df_chk.columns else 0
chk_total = 0 if df_chk.empty else len(df_chk)
...
# ── TABS ─────────────────────────────────────────────────────────────────────
tab_vue,tab_itin,tab_mapa,tab_clima,tab_museos,tab_aloj,tab_trans,tab_gas_t,tab_pres,tab_chk,tab_frases,tab_tips,tab_notas_t = st.tabs([
...
# ══ MAPA ══════════════════════════════════════════════════════════════════════
with tab_mapa:
    M('<div class="sh"><div class="sh-t">🌍 Ruta completa — La U</div><div class="sh-m">Milán → Cinque Terre → Florencia → Roma → Nápoles → Amalfi → Venecia → Zurich</div></div>')
    ...
    for i, c in enumerate(RUTA_MAPA):
        color = c["color"]
        popup_html = f"""
        <div style="font-family:DM Sans,sans-serif;min-width:140px">
          <div style="font-size:1.1rem;margin-bottom:4px">{c['emoji']} <strong>{c['city']}</strong></div>
          <div style="font-size:0.78rem;color:#6B7A8D">{c['dias']}</div>
        </div>"""
        folium.CircleMarker(
            ...
            tooltip=f"{c['emoji']} {c['city']} · {c['dias']}"
        ).add_to(m)

        if "excursión" not in c["dias"]:
            folium.Marker(
                location=[c["lat"]+0.15, c["lon"]],
                icon=folium.DivIcon(
                    html=f'<div style="font-size:0.65rem;font-weight:700;color:{color};white-space:nowrap;background:white;padding:1px 4px;border-radius:4px;border:1px solid {color}">{c["city"]}</div>',
    ...
    <div style="display:flex;align-items:center;gap:6px;font-size:0.78rem"><span style="width:30px;height:2px;background:#C4693A;border-top:2px dashed #C4693A;display:inline-block"></span>Ruta en U</div>
    </div>""")

# ══ CLIMA ═════════════════════════════════════════════════════════════════════
with tab_clima:
    M('<div class="sh"><div class="sh-t">🌤️ Clima durante el viaje</div><div class="sh-m">Pronóstico para la fecha de llegada a cada ciudad · API Open-Meteo · Datos reales cuando se acerca la fecha</div></div>')
    _al("<strong>ℹ️ Nota:</strong> Open-Meteo provee pronóstico extendido. A medida que se acerque la fecha del viaje, los datos serán más precisos. Las temperaturas de mayo/junio en Italia son ideales: 22–28°C.")

    cols = st.columns(4)
    ciudades_list = list(CIUDADES_CLIMA.items())
    for i, (nombre, datos) in enumerate(ciudades_list):
        with cols[i % 4]:
            clima = get_clima(datos["lat"], datos["lon"], datos["fecha"])
            if clima:
                desc = WMO_CODES.get(clima["code"], "🌤️")
                rain_bar = "💧" * min(5, clima["rain"] // 20) if clima["rain"] else ""
                M(f"""<div class="clima-card">
                  <div style="font-size:1.4rem">{desc.split()[0]}</div>
                  <div class="clima-temp">{clima["max"]}°</div>
                  <div style="font-size:0.72rem;color:#6B7A8D">Mín {clima["min"]}°C · Máx {clima["max"]}°C</div>
                  <div class="clima-city"><strong>{nombre}</strong><br>{datos["fecha"]}</div>
                  <div class="clima-desc">{" ".join(desc.split()[1:])}</div>
                  {f'<div style="font-size:0.7rem;color:#4285F4;margin-top:3px">Lluvia: {clima["rain"]}% {rain_bar}</div>' if clima["rain"] else ''}
                </div>""")
                st.write("")
            else:
                M(f'<div class="clima-card"><div style="font-size:1.4rem">🌤️</div><div class="clima-city"><strong>{nombre}</strong><br>{datos["fecha"]}</div><div style="font-size:0.72rem;color:#6B7A8D;margin-top:4px">Datos disponibles cuando se acerque la fecha</div></div>')
                st.write("")

    M("""<div style="margin-top:1rem">
    <div class="sh"><div class="sh-t" style="font-size:1.1rem">Qué llevar según el clima</div></div>
    </div>""")
    cols2 = st.columns(3)
    with cols2[0]:
        M("""<div class="hc"><div style="font-size:1.2rem;margin-bottom:6px">☀️ Italia (mayo–junio)</div>
        <div style="font-size:0.78rem;color:#6B7A8D;line-height:1.7">
        · Temperaturas: 20–28°C<br>· Protector solar FPS 50+ esencial<br>
        · Ropa liviana pero con mangas para iglesias<br>
        · Sandalias para la ciudad, zapatos firmes para Amalfi<br>
        · Puede llover algún día — llevar capa liviana
        </div></div>""")
    with cols2[1]:
        M("""<div class="hc"><div style="font-size:1.2rem;margin-bottom:6px">🇨🇭 Zurich (junio)</div>
        <div style="font-size:0.78rem;color:#6B7A8D;line-height:1.7">
        · Temperaturas: 16–22°C (más fresco que Italia)<br>
        · Llevar una campera o sweater<br>
        · Puede llover con más frecuencia<br>
        · Los Alpes pueden estar nevados (panorama increíble)<br>
        · Para Uetliberg: ropa un poco más abrigada
        </div></div>""")
    with cols2[2]:
        M("""<div class="hc"><div style="font-size:1.2rem;margin-bottom:6px">🥾 Para senderismo</div>
        <div style="font-size:0.78rem;color:#6B7A8D;line-height:1.7">
        · Cinque Terre: calzado cerrado con suela<br>
        · Sentiero degli Dei: zapatillas de trekking<br>
        · Llevar agua (mínimo 1.5L por persona)<br>
        · Sombrero y protector solar<br>
        · El Sentiero baja siempre — no hay que escalar
        </div></div>""")

# ══ MUSEOS ════════════════════════════════════════════════════════════════════
with tab_museos:
    M('<div class="sh"><div class="sh-t">🎟️ Museos y Entradas</div><div class="sh-m">Reservar en el sitio oficial · Cargar N° de confirmación cuando esté hecho</div></div>')
...
with tab_aloj:
    ...
    for r in RESERVAS_ALOJ:
        ...
        with st.form(key=f"fa_{r['id']}"):
            ...
            nn=st.text_area("Notas",value=str(rd.get("notas_int","")),key=f"na_{r['id']}",height=50,placeholder="Ej: Check-in 15hs · Pedir habitación alta...")
...
with tab_pres:
    ...
    st.write("")
    PRES_FILAS=[("Milán","3","€80","€240"),("La Spezia","2","€75","€150"),("Florencia","4","€100","€400"),("Roma","4","€88","€350"),("Nápoles","1","€80","€80"),("Costa Amalfi","2","€92","€185"),("Venecia","1","€100","€100"),("Zurich","3","€100","€300"),("TOTAL","20","~€95","~€1.805")]
    ...
    st.write("")
    M("""<div class="al alb"><strong>💡 Calculadora de propinas y coperto:</strong>
    En Italia no hay propina obligatoria, pero muchos restaurantes cobran "coperto" (cubierto) de €1–3 por persona.
    Si la cuenta dice €40 y hubo €2 coperto x2 personas = €4, el total real a pagar es €44.
    En Suiza, el servicio está incluido — no se deja propina. Si quedaron muy satisfechos, redondean.</div>""")

    st.write(""); st.markdown("**Calculadora rápida**")
...
with tab_chk:
    ...
    if not df_chk.empty and "item" in df_chk.columns:
        ...
        M(f'<div class="prog-o"><div class="prog-i" style="width:{pct_chk}%"></div></div>'
          f'<div style="font-size:0.78rem;color:#6B7A8D;margin:4px 0 1rem">{done_count} de {total_count} items completados ({pct_chk}%)</div>')
        ...
        for cat in cats_chk:
            ...
            M(f'<div style="font-size:0.78rem;font-weight:700;color:#3D4A5C;margin:1rem 0 4px">{cat} ({cat_done}/{len(items)})</div>'
              f'<div class="dc" style="margin-bottom:0.5rem">')
            for _,item in items.iterrows():
                ...
                if st.button(f"{'↩️ Desmarcar' if is_done else '✅ Marcar'}", key=f"chk_{item_id}"):
                    if toggle_check(item_id, item.get("done","0")):
                        st.rerun()
            M('</div>')
    else:
        st.info("Cargando checklist... Si es la primera vez, se inicializará automáticamente.")
...
with tab_frases:
    ...
    with col_it:
        ...
        categorias_it = list(dict.fromkeys(f[0] for f in FRASES_ITALIANO))
        cat_sel = st.radio("Categoría", categorias_it, horizontal=True, label_visibility="collapsed")
    ...
    with col_ch:
        ...
        for cat, es, de, fon in FRASES_SUIZO:
            M(f'<div class="frase-card"><div class="frase-es">{es}</div><div class="frase-it">{de}</div><div class="frase-fn">🔊 {fon}</div></div>')

    st.write("")
    M("""<div class="al alb">
    <strong>💡 Tip:</strong> En toda Italia el inglés funciona bien en zonas turísticas. Lo que realmente agrada a los italianos
    es cuando un turista intenta pronunciar aunque sea "Grazie" y "Per favore" — inmediatamente mejora la actitud del local.
    En Zurich la mayoría habla inglés perfectamente. No se preocupen.
    </div>""")
